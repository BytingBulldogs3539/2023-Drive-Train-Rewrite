...
public class RightBlueHighConeBack extends SequentialCommandGroup {
    /** Creates a new SplineAuton. */
    MPLoader loader = new MPLoader("RightBlueHighConeBack.txt", false);
